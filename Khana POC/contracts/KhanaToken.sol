...
contract KhanaToken is MintableToken {
     ...
     */
    function award(address _account, uint256 _amount, string _ipfsHash) public onlyAdmins contractIsEnabled
    {
     ...
     */
    function awardBulk(address[] _accounts, uint256 _amount, string _ipfsHash) public onlyAdmins contractIsEnabled returns (uint)
    {
