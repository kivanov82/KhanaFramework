...
class App extends Component {
    ...
    awardTokens =(event) => {
        ...
        getIpfsFile.then((ipfsResult) => {
            ...
            this.updateLoadingMessage('Entry added to IPFS audit file successfully (with IPFS hash: ' + ipfsHash + '). Please confirm the ethereum transaction via your MetaMask wallet and wait for it to confirm.')
